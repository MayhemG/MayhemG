current_feelings = {'good':'Your having a good day, thats great hopefully it stays that way',  
                 ...
                 'contact':'If you would like to contact me email me at Hammay@176gmail.com, suggestions are appreciated. Btw im new to Python but i am very intrested Have a good day :P '}
...
if Day == None: 
        print ('Sorry please choose between good, alright, bad, depressed, or contact')
else:
        print(' you chose ...\n', feelings,'...', Day )
